...
import com.easy.db.SubjectDB;
import com.easy.jwxt.JwUtils;
import com.easy.mycustom.PickerView;
...
//            System.out.println(course.startWeek + " " + course.endWeek);
                        ...
                        SharedPreferences.Editor editor = MyApplication.getContext().getSharedPreferences("HW", MyApplication.getContext().MODE_PRIVATE).edit();
...
//                        int widthPx = dip2px(mActivity, 47);
    ...
    protected View initView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        sharedPreferences = MyApplication.getContext().getSharedPreferences("last", MyApplication.getContext().MODE_PRIVATE);
        ...
        if (arrayList.size() == 0) {
            ...
            heightPx = MyApplication.getContext().getSharedPreferences("HW", Context.MODE_PRIVATE).getInt("heightpx", 0);
            widthPx = MyApplication.getContext().getSharedPreferences("HW", Context.MODE_PRIVATE).getInt("widthpx", 0);
            LoadButton();
        }
