...
import com.example.zhaoshuang.weixinrecordeddemo.MainActivity;
...
//                popWindow.dismiss();
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                if (position == 0) {
                    ...
                    toolbar.setBackgroundColor(0xff0096ff);
                } else {
                    footnagavite.setVisibility(View.GONE);
                    tv_msg.setTextColor(getResources().getColor(R.color.huibai));
    ...
    private void initView() {
       ...
       // SuggestFragment suggestFragment = new SuggestFragment();
        NewSuggestViewPager suggestFragment =new NewSuggestViewPager();
...
//                qupaiService.showRecordPage(this, RequestCode.RECORDE_SHOW, false);
                ...
                startActivityForResult(intent,RequestCode.RECORDE_SHOW);
                break;
            }
