    ...
    private void Refresh(final MainMessageParse mainMessageParse) {
        OkHttpUtils.get().url(Datas.GetFriendFeeds).addParams("userId", Config.userid)
            ...
            public void onError(Call call, Exception e, int id) {
                ...
                //5张图
                String json = "{\"userInfo\":{\"nickname\":\"五颜六色\",\"headurl\":\"http://115.159.159.65:8080/EAsy/Headurl/3ebcfd6f-f456-429a-bf64-ca04f508.jpg\",\"sign\":\"天地宽广，向往之。\",\"id\":50},\"messageInfo\":{\"id\":1,\"alike\":1,\"time\":\"2016/6/30 19:27\",\"resent\":0,\"comment\":1,\"like\":10,\"see\":1000},\"content\":\"然而我也不知道测试什么东西，发几张图和视频测试下\",\"imgs\":[\"http://115.159.159.65:8080/EAsy/ImageSrc/0fc7fa54-705c-4e38-a0a6-d0c06aca.jpg\",\"http://115.159.159.65:8080/EAsy/ImageSrc/8a0be53c-5d1d-40d8-bc07-d8cf906f.jpg\",\"http://115.159.159.65:8080/EAsy/ImageSrc/a60390ad-0ff7-44da-992d-e1a4f20a.jpg\",\"http://115.159.159.65:8080/EAsy/ImageSrc/abfbbeb5-cfdb-4971-bedc-6afe5d2c.jpg\",\"http://115.159.159.65:8080/EAsy/ImageSrc/b5fd8b15-8771-45ac-b80c-9942bba6.jpg\"],\"video\":\"\",\"resendInfo\":{\"video\":\"\",\"nick\":\"\",\"uid\":\"\",\"imgs\":[]}}";
                mainMessageBeen = mainMessageParse.Parse(json);
                arrayList.add(mainMessageBeen);

                //视频
                json = "{\"userInfo\":{\"nickname\":\"动力小车@何叔平\",\"headurl\":\"http://115.159.159.65:8080/EAsy/Headurl/f6aa7245-5d3c-4887-8e78-8482fb28.jpg\",\"sign\":\"天地宽广，向往之。\",\"id\":1},\"messageInfo\":{\"id\":1,\"alike\":1,\"time\":\"2016/6/30 19:27\",\"resent\":0,\"comment\":1,\"like\":10,\"see\":1000},\"content\":\"这是一段测试用的文字。。。\",\"imgs\":[],\"video\":\"http://115.159.159.65:8080/EAsy/test.mp4\",\"resendInfo\":{\"video\":\"\",\"nick\":\"\",\"uid\":\"\",\"imgs\":[]}}";
                mainMessageBeen = mainMessageParse.Parse(json);
                arrayList.add(mainMessageBeen);


                //4张
                json = "{\"userInfo\":{\"nickname\":\"五颜六色\",\"headurl\":\"http://115.159.159.65:8080/EAsy/Headurl/3ebcfd6f-f456-429a-bf64-ca04f508.jpg\",\"sign\":\"天地宽广，向往之。\",\"id\":1},\"messageInfo\":{\"id\":1,\"alike\":1,\"time\":\"2016/6/30 19:27\",\"resent\":0,\"comment\":1,\"like\":10,\"see\":1000},\"content\":\"这是一段测试用的文字。。。\",\"imgs\":[\"http://115.159.159.65:8080/EAsy/ImageSrc/b5fd8b15-8771-45ac-b80c-9942bba6.jpg\",\"http://115.159.159.65:8080/EAsy/ImageSrc/b5fd8b15-8771-45ac-b80c-9942bba6.jpg\",\"http://115.159.159.65:8080/EAsy/ImageSrc/b5fd8b15-8771-45ac-b80c-9942bba6.jpg\",\"http://115.159.159.65:8080/EAsy/ImageSrc/b5fd8b15-8771-45ac-b80c-9942bba6.jpg\"],\"video\":\"\",\"resendInfo\":{\"video\":\"\",\"nick\":\"\",\"uid\":\"\",\"imgs\":[]}}";
                mainMessageBeen = mainMessageParse.Parse(json);
                arrayList.add(mainMessageBeen);
                ...
                arrayList.add(mainMessageBeen);
                //2张
                json = "{\"userInfo\":{\"nickname\":\"五颜六色\",\"headurl\":\"http://115.159.159.65:8080/EAsy/Headurl/3ebcfd6f-f456-429a-bf64-ca04f508.jpg\",\"sign\":\"天地宽广，向往之。\",\"id\":1},\"messageInfo\":{\"id\":1,\"alike\":1,\"time\":\"2016/6/30 19:27\",\"resent\":0,\"comment\":1,\"like\":10,\"see\":1000},\"content\":\"然而我也不知道测试什么东西，发几张图和视频测试下\",\"imgs\":[\"http://115.159.159.65:8080/EAsy/ImageSrc/9e00f9d2-90fc-4011-9ec6-78fdbbb5.jpg\",\"http://115.159.159.65:8080/EAsy/ImageSrc/fdac0db5-a6d1-46e2-8522-e83ad0ad.jpg\"],\"video\":\"\",\"resendInfo\":{\"video\":\"\",\"nick\":\"\",\"uid\":\"\",\"imgs\":[]}}";
                mainMessageBeen = mainMessageParse.Parse(json);
                arrayList.add(mainMessageBeen);
