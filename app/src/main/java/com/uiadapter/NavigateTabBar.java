...
public class NavigateTabBar extends LinearLayout implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (object != null && object instanceof ViewHolder) {
            ...
            if(((ViewHolder) object).fragmentClass==null){
                Intent intent = new Intent(getContext(), ParallaxUserInfoDisplayActivity.class);
                //在这里传递一些数据进入
                ...
                if(NewSuggestViewPager.class == holder.fragmentClass){
                    NewMainActivity.toolbar.setBackgroundColor(Color.BLACK);

                }else{
                    NewMainActivity.toolbar.setBackgroundColor(getResources().getColor(R.color.titlecolor));
